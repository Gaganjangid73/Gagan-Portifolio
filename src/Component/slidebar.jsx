...
const Slidebar = () => {
  return (
    <div className="ml-30 mt-20 w-[320px] h-[600px] bg-white rounded-2xl flex flex-col ">
      ...
      <div className=" flex items-center justify-evenly text-2xl text-amber-600 mt-10 w-[300px]">
        <CiLinkedin cursor="pointer"  /> <FaInstagram cursor="pointer"/> <FaSquareXTwitter cursor="pointer" />
      </div>
    </div>
  );
};
